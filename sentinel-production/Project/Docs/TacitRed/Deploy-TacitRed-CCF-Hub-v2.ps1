...
Write-Host "`n═══ DEPLOYING TACITRED CCF HUB V2 (CCF CONNECTOR) ═══" -ForegroundColor Cyan
...
$deploymentName = "tacitred-ccf-hubv2-" + $ts
...
Write-Host "`nDeployment complete (check for connector TacitRedFindings in workspace)." -ForegroundColor Green
