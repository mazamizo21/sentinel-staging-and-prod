      ...
      sampleQueries: [
        {
          ...
          query: 'TacitRed_Findings_CL | where TimeGenerated >= ago(7d) | project TimeGenerated, email_s, domain_s, findingType_s, confidence_d'
        }
        {
          description: 'Compromised credentials by domain'
          query: 'TacitRed_Findings_CL | where findingType_s == "compromised_credential" | summarize CompromisedUsers = dcount(email_s) by domain_s | order by CompromisedUsers desc'
        }
      ]
      dataTypes: [
        {
